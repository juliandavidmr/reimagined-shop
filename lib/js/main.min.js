          ...
          headers:{
            ...
            this.$get=["$httpBackend","$browser","$cacheFactory","$rootScope","$q","$injector",function(t,e,r,i,l,h){
              function p(t){
                function e(t){
                  var e=f({},t,{
                    data:Vt(t.data,t.headers,r.transformResponse)
                  });
...
!function(o,n,e){
  "use strict";
  n.module("ngCookies",["ng"])
  .factory("$cookies",["$rootScope","$browser",function(o,i){
    var t,r={},c={},f=!1,u=n.copy,s=n.isUndefined;
    return i.addPollFn(function(){
      var n=i.cookies();
      t!=n&&(t=n,u(n,c),u(n,r),f&&o.$apply())})(),f=!0,o.$watch(function(){
        var o,t,f;
        for(o in c)s(r[o])&&i.cookies(o,e);
        for(o in r)t=r[o],n.isString(t)||(t=""+t,r[o]=t),t!==c[o]&&(i.cookies(o,t),f=!0);
        if(f)for(o in t=i.cookies(),r)r[o]!==t[o]&&(s(t[o])?delete r[o]:r[o]=t[o])}),r}])
